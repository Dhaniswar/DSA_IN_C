...
Insert a node after given position in the Doubly linlked list
*/
...
struct node *insert_node_after_given_pos(struct node *head, struct node **tail){
    ...
    printf("Insert node after %d position: \n", pos);
    scanf("%d", &newnode->data);
    ...
    printf("Node inserted successfully after the %d position!\n", pos);
    return head;
...
int main() {
    ...
    head = insert_node_after_given_pos(head, &tail);
